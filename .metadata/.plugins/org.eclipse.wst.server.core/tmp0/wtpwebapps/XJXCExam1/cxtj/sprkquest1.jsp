...
<tr>
    ...
    &nbsp;<span  class="word_deepgrey"> 当前位置：查询统计> </span>商品入库查询 &gt;&gt;&gt;</td>
  </tr>
    <tr><td valign="top" height="83">
      <table width="590" border="0" cellspacing="-2" cellpadding="-2">
        <tr><td width="590" height="41" align="Top" background="../shopping/KCM/quest.gif">
          <form name="form1" method="POST" action="sprkquest.jsp" target="MainFrame">
